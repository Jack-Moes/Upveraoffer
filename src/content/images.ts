...
export const images = {
  ...
  indianCustomerAssistance: {
    src: "/images/people/indian-customer-assistance-v1.jpg",
  ...
  teamMeeting: {
    src: "/images/workplace/team-company-studio-v3.jpg",
    alt: "Upveraoffer's six-person team working across engineering and customer-assistance stations",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamHoliday: {
    src: "/images/workplace/team-holiday-square-v3.jpg",
    alt: "Five Upveraoffer teammates sharing warm drinks at an outdoor holiday market",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  workshop: {
  ...
  teamSightseeing: {
    src: "/images/workplace/team-sightseeing-v3.jpg",
  ...
  officeInterior: {
    src: "/images/workplace/team-equipment-interior-v3.jpg",
    alt: "Five Upveraoffer teammates working with a desktop tower, dual monitors, TV, Dell and Mac laptops, and printers",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  coachingSession: {
  ...
  teamSailing: {
    src: "/images/workplace/team-sailing-offsite-v3.jpg",
    alt: "Five Upveraoffer teammates working together aboard a sailboat",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamHike: {
    src: "/images/workplace/team-hike-overlook-v3.jpg",
    alt: "Five Upveraoffer teammates pausing at a wooded trail overlook",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamLounge: {
    src: "/images/workplace/team-lounge-v3.jpg",
    alt: "Five Upveraoffer teammates taking an informal coffee break in the office lounge",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamVolunteer: {
    src: "/images/workplace/team-volunteer-day-v3.jpg",
    alt: "Five Upveraoffer teammates packing food donations at a community volunteer event",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamGolf: {
    src: "/images/workplace/team-golf-day-v3.jpg",
    alt: "Five Upveraoffer teammates playing a casual round of golf together",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamDinner: {
    src: "/images/workplace/team-dinner-v4.jpg",
