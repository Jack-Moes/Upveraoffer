...
export const images = {
  ...
  teamMeeting: {
    src: "/images/workplace/team-company-studio-v2.jpg",
    alt: "Upveraoffer's four senior developers working independently across laptops, monitors, and a system display",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamHoliday: {
    src: "/images/workplace/team-holiday-square-v2.jpg",
    alt: "Upveraoffer's Indian, Vietnamese, and Chinese developers at an outdoor holiday market",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  workshop: {
  ...
  teamSightseeing: {
    src: "/images/workplace/team-sightseeing-v2.jpg",
    alt: "The team manager with Upveraoffer's Indian, Vietnamese, and Chinese developers exploring a sculpture garden",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  officeExterior: {
  ...
  officeInterior: {
    src: "/images/workplace/team-equipment-interior-v2.jpg",
    alt: "Three Upveraoffer developers using a desktop tower, dual monitors, TV, Dell and Mac laptops, and printer",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  coachingSession: {
  ...
  teamSailing: {
    src: "/images/workplace/team-sailing-offsite-v2.jpg",
    alt: "Upveraoffer's Indian, Vietnamese, and Chinese developers sailing together",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamHike: {
    src: "/images/workplace/team-hike-overlook-v2.jpg",
    alt: "Upveraoffer's Indian, Vietnamese, and Chinese developers at a wooded trail overlook",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamLounge: {
    src: "/images/workplace/team-lounge-v2.jpg",
    alt: "Three Upveraoffer developers taking a casual break in an office lounge",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamVolunteer: {
    src: "/images/workplace/team-volunteer-day-v2.jpg",
    alt: "Three Upveraoffer developers packing food donations at a community volunteer event",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamGolf: {
    src: "/images/workplace/team-golf-day-v2.jpg",
    alt: "Three Upveraoffer developers playing a casual round of golf together",
    credit: "Upveraoffer",
    creditUrl: "https://upveraoffer.com",
  },
  teamDinner: {
