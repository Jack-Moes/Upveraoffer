      ...
      <div className="border-b border-border bg-surface">
        <Container className="py-16 sm:py-20">
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_1fr]">
            ...
            <div className={`photo-frame relative overflow-hidden rounded-xl border border-border bg-surface-2 shadow-xl shadow-primary/5 ${service.slug === "resume" ? "aspect-[3/2]" : "aspect-[7/5]"}`}>
              <Image
